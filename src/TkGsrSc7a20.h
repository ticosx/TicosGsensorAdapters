...
{
    //0x2E,0x00,0x00,//
    0x20,0x5F,0x00,//使能x,y,z轴，LPen =1低功耗模式，100Hz,
    0x23,0x18,0x00,//连续更新数据块，大端数据，±4G量程，数字低通滤波器使能
    0x24,0x40,0x00,//使能FIFO模式，
    0x2E,0x87,0x00,//stream 模式，阈值是7
    //于中断相关配置
    0x21,0x81,0x00,//设置数据高通
    0x22,0x40,0x00,//使能AOI1中断，AOI1中断在INT1 脚上
    0x30,0x7F,0x00,//6个方向运动识别，x,y,z高低事件中断
    0x32,0x03,0x00,//AOI1 阈值为3（此值可以调整）
    0x33,0x03,0x00,//设置轴的数据需要连续大于阈值 3 次才能产生中断
};
